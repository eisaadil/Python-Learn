...
class TestBinarySearch(unittest.TestCase):
    ...
    def binary_search_iterative(self, input_array, value): #Proper iterative solution
        start = 0
    ...
    def binary_search_recursive(self, input_array, value, start=0, end=None):
    ...
    def test_search(self):
        ...
        for i in range(0,100):
            with self.subTest(i=i):
                r = randint(0,len(s)-1)
                self.assertEqual(self.binary_search_recursive(s,s[r]), r)
